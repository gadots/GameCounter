...
export default {
  ...
  inputs: [
    ...
    { id: 'stone_rooms',    label: 'Habitaciones de piedra',  type: 'stepper', min: 0, description: '+1 VP extra por cada habitación de piedra (no de barro)' },
    { id: 'family_members', label: 'Miembros de familia',     type: 'stepper', min: 2, max: 5, description: '+3 VP por cada miembro' },
    { id: 'bonus_cards',    label: 'Cartas y mejoras (pts)', type: 'number',  description: 'Suma de puntos de Ocupaciones y Mejoras de hogar' },
  ],

  score({ fields, pastures, grain, vegetables, sheep, pigs, cattle, unused_spaces, stables, stone_rooms, family_members, bonus_cards }) {
